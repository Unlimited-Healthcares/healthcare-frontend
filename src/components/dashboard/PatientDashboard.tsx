            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="eol_docs">
                    <div className="p-12 text-center bg-slate-50 rounded-3xl border border-dashed border-slate-200">
                        ...
                        <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">No EOL Documents Issued</p>
                        <p className="text-[10px] text-slate-300 mt-1">Official documentation will appear here when generated by clinical staff.</p>
                    </div>
                </TabsContent>
